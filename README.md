...
Capture and save complete transcripts with detailed timing information. Each entry includes movie timestamps, translation delays, and translated text.
...
### Transcript Management
- Use "Save Transcript" to download your current transcript
- Transcripts are saved in format: `[Movie timing] || [delay] || [text]`
- Use "Delete Transcript" to clear stored data

## 🏗️ Technical Architecture

### Extension Structure
- **Content Script**: Manages Netflix integration, subtitle detection, and translation
- **Background Script**: Handles transcript storage and data persistence
- **Popup Interface**: Provides user interface for settings and transcript management

### Data Format
```javascript
{
  translatedText: "Translated subtitle text",
  movieTime: 65.5,           // Video timestamp in seconds
  translationDelay: 1250,    // API response time in milliseconds
